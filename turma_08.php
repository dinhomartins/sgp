<?php
    ...
    $filtro_horario = '08:00 - 09:00';
    $dia_da_semana = 'Segunda - Quarta';
    $cursando = 'cursando';
    $trancado = 'trancado';
    $cancelado = 'cancelado';
    $espera = 'espera';
                    ...
                    <form method="post" action="" id="formCadastrarse">
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                               <div class="row">
                                   <div class="col-md-4">
                                       <a href="turma_08pdf2.php" target="_blank" class="btn btn-warning" style="margin-bottom:20px" >Imprimir lista de presença</a>
                                   </div>
                               </div>
