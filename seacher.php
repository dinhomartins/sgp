<?php
    ...
    $resultado_todos =    " SELECT * FROM cad_aluno WHERE id LIKE '$pesquisar' ";
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label >Informe o nome completo.</label>
                                    <input type="text" readonly class="form-control " id="nome" name="nome" value="<?php echo $resultado_pesquisa_db['nome']; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-grupo">
                                   <label >Informe o nome da rua, bairro e quadra</label>
                                    <input type="text" class="form-control" id="endereco" name="endereco" value="<?php echo $resultado_pesquisa_db['endereco']; ?>" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
